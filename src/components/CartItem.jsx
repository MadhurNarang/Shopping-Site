      ...
      <div className="flex flex-row p-3 gap-5 items-center">
        ...
        <div className="w-[70%] self-start space-y-5 ml-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <button className="text-red-800 text-xl bg-red-100 group hover:bg-red-200 transition-transform duration-300 cursor-pointer rounded-full p-3 mr-3" onClick={removeFromCart}>
              <AiFillDelete />
            </button>
          </div>
        </div>
